...
<?php	
    ...
    $query=" SELECT id, nombre, precio, codigo, categoria FROM productos ORDER BY fecha DESC";
      ?>
<!DOCTYPE html>
<html lang="es">
  <head>
                        ...
                        <div class="woocommerce">
                                <div class="table-responsive">
                                    <table cellspacing="0" class="shop_table cart">
                                        <thead>
                                            <tr>
                                                <th class="product-thumbnail"><i class="" aria-hidden="true"></i> Foto</th>
                                ...
                                <div class="cart_totals col-sm-6 col-xs-12">
                                    ...
                                    <table cellspacing="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Subtotal</td>
                                                <td>$<?php echo number_format($subtota1= $subtotal-($subtotal*0.19), 0, ',', '.');?></td>
                                            </tr>
                                            <tr>
                                                <td>iva 19%</td>
                                            ...
                                            <tr class="order-total">
                                                <th>Total Pedido</th>
                                                <td><strong><span class="amount">$<?php echo number_format($total = $subtota1+$iva, 0, ',', '.');?></span></strong> </td>
                                            </tr>
                                            <tr>
