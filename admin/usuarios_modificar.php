...
<?php
	if($_POST['enviar'] == "Modificar"){
		echo $q="UPDATE `clientes` SET `nombre` = '$_POST[nombre]', `email` = '$_POST[email]', `telefono` = '$_POST[telefono]', `usuario` = '$_POST[usuario]', `contrasena` = '$_POST[contrasena]' WHERE `clientes`.`id` = $_POST[id];";
