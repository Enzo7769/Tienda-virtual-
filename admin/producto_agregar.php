...
<?php
	if($_POST['agregarProducto'] == "agregarProducto"){
		...
		$q="INSERT INTO `productos` (`id`, `nombre`, `codigo`, `categoria`, `unidad`, `precio`, `disponibilidad`, `descripcion`, `promocion`, `fecha`) VALUES (NULL, '$_POST[nombre]', '$_POST[codigo]', '$_POST[categoria]', '$unidad', '$_POST[precio]', '$_POST[disponibilidad]', '$_POST[descripcion]', '$_POST[promocion]', CURRENT_TIMESTAMP)";
		//echo($q);
        ...
        fields: {
			...
			descripcion: {
                validators: {
                    ...
                    notEmpty: {
                        message: 'Ingrese Descripción Del Producto (Mínimo 6 caracteres)'
                    }
                }
            },
           	unidad: {
